        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16 max-w-7xl">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              />
              <button className="px-6 py-3 bg-gradient-to-r from-[#ad4a16] via-[#8f3a17] to-[#312518] text-white font-semibold rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center whitespace-nowrap">
