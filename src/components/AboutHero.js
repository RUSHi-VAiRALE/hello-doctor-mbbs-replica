    ...
    <div className="relative h-[300px] md:h-[400px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center justify-center">
        <div className="text-center px-4">
          ...
          {/* Main Heading */}
          <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent uppercase tracking-wider">
            {page}
          </h1>

          {/* Breadcrumb */}
          <nav className="text-base md:text-lg font-medium">
            <a href="/" className="text-blue-200 hover:text-white transition-colors font-bold">
              {route}
            </a>
            <span className="text-blue-300 mx-3">
