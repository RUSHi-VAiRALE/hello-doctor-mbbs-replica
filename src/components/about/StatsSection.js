...
export default function StatsSection() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 lg:px-16 max-w-7xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl">
                {/* Icon */}
                ...
                {/* Label */}
                <div className="text-blue-200 font-medium group-hover:text-blue-100 transition-colors duration-300">
                  {stat.label}
                </div>
