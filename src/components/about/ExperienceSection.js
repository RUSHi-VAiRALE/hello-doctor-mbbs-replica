        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-teal-800 to-green-800 bg-clip-text text-transparent">
              We're <span className="text-teal-600">Experienced</span> in Consulting Abroad Education
            </h2>
            ...
            <p className="text-gray-700 mb-8 text-lg">
              <strong className="text-teal-800">Join us today</strong> and experience expert guidance for your international education journey!
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/onlineResources" className="inline-block px-6 py-3 bg-gradient-to-r from-teal-500 to-green-600 text-white font-semibold rounded-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                Learn More →
              </Link>
              <Link href="/admission" className="inline-block px-6 py-3 border-2 border-teal-400 text-teal-600 font-semibold rounded-lg hover:bg-teal-400 hover:text-white transition-all duration-300">
                How it Works →
              </Link>
            </div>
          </div>
          ...
          <div className="lg:w-1/2">
            <div className="relative w-[280px] md:w-[320px] h-[280px] md:h-[320px] mx-auto">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[130px] md:w-[160px] h-[130px] md:h-[160px] rounded-full bg-gradient-to-r from-teal-500 to-green-600 flex items-center justify-center text-center text-white font-bold text-lg md:text-xl shadow-2xl">
