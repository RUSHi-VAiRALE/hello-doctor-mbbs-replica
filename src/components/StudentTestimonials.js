      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 lg:px-16 max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((item, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl h-64 md:h-72 bg-white/80 backdrop-blur-sm border border-teal-200/50 hover:bg-white/90 transition-all duration-300">
                {/* Background Image */}
                <div
