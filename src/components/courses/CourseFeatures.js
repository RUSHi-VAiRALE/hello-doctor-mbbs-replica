  ...
  return (
    <div className="bg-white rounded-t-0 rounded-b-2xl p-4 sm:p-8 shadow-xl">
      ...
      <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
        {/* Regular Batch */}
        <div className={`group relative border-2 rounded-xl p-4 sm:p-6 bg-gradient-to-r from-amber-50 to-red-50 transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] ${selectedPlan === 'regular'
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-b from-transparent via-black/50 to-black/70 opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-xl">
            <button
              ...
              className="bg-gradient-to-r from-[#ad4a16] via-[#8f3a17] to-[#312518] text-white px-8 py-3 rounded-full font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg"
            >
              Select Plan
            </button>
          </div>
        ...
        {/* Pro Batch */}
        <div className={`group relative border-2 rounded-xl p-4 sm:p-6 bg-gradient-to-r from-gray-900 to-gray-800 text-white transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] ${selectedPlan === 'pro'
