  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 w-full">
      <div className="relative">
        ...
        <div className="absolute top-0 left-0 bg-gradient-to-r from-[#ad4a16] via-[#8f3a17] to-[#312518] text-white px-3 py-1 rounded-r-lg text-sm">
          {course.tag}
        </div>
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button className="bg-gradient-to-r from-[#ad4a16] via-[#8f3a17] to-[#312518] text-white py-2.5 rounded-full font-medium hover:shadow-lg transition-shadow">
            BUY NOW
          </button>
        </div>
      </div>
